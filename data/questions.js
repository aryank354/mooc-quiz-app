...
export const oopsQuestions = [
  ...
  // OOPs Week 1
  { id: 206, week: 1, assignment: 1, question: "Which of the following OOP principles ensures that a derived class can modify behavior inherited from a base class?", options: ["Inheritance", "Abstraction", "Encapsulation", "Polymorphism"], correctAnswer: 3 },
  { id: 207, week: 1, assignment: 1, question: "Which of the following is not a characteristic of object-oriented programming?", options: ["Encapsulation", "Polymorphism", "Functional composition", "Inheritance"], correctAnswer: 2 },
  { id: 208, week: 1, assignment: 1, question: "If a class is considered a “set” in mathematical terms, which of the following could be considered as objects?", options: ["Functions defined on the set", "Elements of the set", "Subsets of the set", "Realized instances of the set (e.g., empty set)"], correctAnswer: 3 },
  { id: 209, week: 1, assignment: 1, question: "Encapsulation can be mathematically represented as:", options: ["f : X → Y where X and Y represent private and public data, respectively.", "f : A → A where f is identity over the class.", "X = Y implying data and methods are the same.", "f : X → X where f is a structure-preserving map over private data."], correctAnswer: 0 },
  { id: 210, week: 1, assignment: 1, question: "Which of the following best describes polymorphism in a mathematical sense?", options: ["Multiple functions f1 : A → B, f2 : C → D, etc., with the same name but possibly independent input-output types.", "A single function f defined as f : A → B and f : C → D, operating across different domains and codomains.", "A function f : A → A that maps elements within the same domain and codomain.", "A composite function f ◦ g : X → Y , where g : X → Z and f : Z → Y , used to chain operations."], correctAnswer: 0 },
  { id: 211, week: 1, assignment: 1, question: "Inheritance in OOP is most analogous to:", options: ["Set theory: Subsets inheriting properties of supersets.", "Group theory: Groups inheriting properties of subgroups.", "Graph theory: Nodes inheriting edges.", "Linear algebra: Matrices inheriting vector spaces."], correctAnswer: 0 },
  { id: 212, week: 1, assignment: 1, question: "Which of the following best encapsulates the core purpose of object-oriented programming?", options: ["Maximizing code reuse and scalability.", "Simplifying logical flow in functional applications.", "Optimizing mathematical operations on datasets.", "Ensuring type safety at runtime."], correctAnswer: 0 },
  { id: 213, week: 1, assignment: 1, question: "In an object-oriented system, relationships between objects are best modeled as:", options: ["Directed graphs", "Bipartite graphs", "Sets with cardinality constraints", "Undirected graphs"], correctAnswer: 0 },
  { id: 214, week: 1, assignment: 1, question: "Which of the following best explains the idea of abstraction in OOP?", options: ["Hiding unnecessary details and showing only the relevant features.", "A mapping between two completely unrelated concepts.", "Defining all possible implementations explicitly in a class.", "Combining unrelated objects into a single type."], correctAnswer: 0 },
  { id: 215, week: 1, assignment: 1, question: "Polymorphism in OOP is analogous to which of the following concepts?", options: ["A function that behaves differently depending on the input.", "Using the same name for multiple variables in a program.", "A method that only works with one specific type of data.", "Changing the internal logic of a program without altering its behavior."], correctAnswer: 0 },
  // OOPs Week 2
  { id: 216, week: 2, assignment: 2, question: "Which of the following best describes a class in object-oriented programming?", options: ["A block of code that defines functions only.", "A blueprint for creating objects, encapsulating data and methods.", "A template for functions without data.", "A data structure for storing primitive data types."], correctAnswer: 1 },
  { id: 217, week: 2, assignment: 2, question: "What happens when an object is created from a class in C++?", options: ["Memory is allocated for the object's member variables only.", "Memory is allocated for member functions and variables.", "Member functions are inherited and memory is allocated for them.", "Member functions are shared across objects, and memory is allocated only for variables."], correctAnswer: 3 },
  { id: 218, week: 2, assignment: 2, question: "Which of the following statements about constructors is false?", options: ["Constructors must have the same name as the class.", "Constructors can be overloaded in C++.", "Constructors cannot be private in C++.", "Constructors do not have a return type."], correctAnswer: 2 },
  { id: 219, week: 2, assignment: 2, question: "In a Java program to define a class Circle with a constructor that initializes its radius and a method getArea() to return the area. Identify the correct syntax to create an object of this class.", options: ["Circle c1 = new Circle();", "Circle c1 = new Circle(radius);", "Circle c1 = Circle(radius);", "Circle c1 = new Circle[radius];"], correctAnswer: 1 },
  { id: 220, week: 2, assignment: 2, question: "Consider the following C++ code:\nclass Test {\npublic:\n  Test() { std::cout << \"Constructor called\\n\"; }\n  ~Test() { std::cout << \"Destructor called\\n\"; }\n  void display() { std::cout << \"Display function\\n\"; }\n};\nint main() {\n  Test t1;\n  t1.display();\n  return 0;\n}\nWhat is the output of this program?", options: ["Constructor called, Display function, Destructor called", "Constructor called, Destructor called, Display function", "Display function, Constructor called, Destructor called", "Constructor called, Display function"], correctAnswer: 0 },
  { id: 221, week: 2, assignment: 2, question: "What is the primary purpose of a destructor in C++?", options: ["To initialize an object when it is created.", "To release memory and resources when an object is destroyed.", "To overload operators for memory allocation.", "To define default behavior for inheritance."], correctAnswer: 1 },
  { id: 222, week: 2, assignment: 2, question: "Consider the following C++ code:\nclass Sample {\npublic:\n  Sample() { std::cout << \"Constructor called\\n\"; }\n  ~Sample() { std::cout << \"Destructor called\\n\"; }\n};\nvoid createObject() {\n  Sample obj;\n  std::cout << \"Inside createObject function\\n\";\n}\nint main() {\n  std::cout << \"Before calling createObject\\n\";\n  createObject();\n  std::cout << \"After calling createObject\\n\";\n  return 0;\n}\nWhat is the output of this program?", options: ["Constructor called, Inside createObject, Destructor called, Before calling, After calling", "Before calling createObject, Constructor called, Inside createObject function, Destructor called, After calling createObject", "Before calling createObject, Inside createObject function, Constructor called, Destructor called, After calling createObject", "Before calling createObject, Constructor called, Inside createObject function, After calling createObject, Destructor called"], correctAnswer: 1 },
  { id: 223, week: 2, assignment: 2, question: "A class in C++ has multiple constructors. How does the compiler decide which constructor to use?", options: ["Based on the return type.", "Based on the arguments passed during object creation.", "The first constructor is always used.", "The last constructor is always used."], correctAnswer: 1 },
  { id: 224, week: 2, assignment: 2, question: "In a C++ program that defines a class FileHandler with a constructor that opens a file and a destructor that closes the file. Choose the correct constructor signature:", options: ["FileHandler(std::string filename);", "FileHandler(char* filename);", "FileHandler(const char filename[]);", "All of the above."], correctAnswer: 3 },
  { id: 225, week: 2, assignment: 2, question: "Analyze the following C++ code and identify the correct output:\nclass Rectangle {\n  int length, width;\npublic:\n  Rectangle(int l, int w) : length(l), width(w) {}\n  int area() { return length * width; }\n};\nint main() {\n  Rectangle rect(5, 3);\n  std::cout << rect.area();\n  return 0;\n}", options: ["15", "8", "Compilation error", "Undefined behavior"], correctAnswer: 0 },
  // OOPs Week 3
  { id: 226, week: 3, assignment: 3, question: "Consider the following C++ code:\nclass A {\npublic:\n  void display() { std::cout << \"Base class A\\n\"; }\n};\nclass B : public A {\npublic:\n  void show() { std::cout << \"Derived class B\\n\"; }\n};\nint main() {\n  B obj;\n  obj.display();\n  obj.show();\n  return 0;\n}\nWhat is the output of the above program?", options: ["Base class A\nDerived class B", "Derived class B\nBase class A", "Base class A", "Derived class B"], correctAnswer: 0 },
  { id: 227, week: 3, assignment: 3, question: "In C++, ambiguity occurs in multiple inheritance when:", options: ["A derived class has a method with the same name as a method in the base class.", "Two base classes have methods with the same name, and a derived class inherits from both.", "A derived class has no constructor defined.", "A base class has a private member function."], correctAnswer: 1 },
  { id: 228, week: 3, assignment: 3, question: "In a program to demonstrate multilevel inheritance with the following requirements:\n• Class A contains a method display() that prints \"Class A\".\n• Class B inherits from A and adds a method show() that prints \"Class B\".\n• Class C inherits from B and adds a method output() that prints \"Class C\".\nWhich of the following correctly calls all three methods from an object of C?", options: ["C obj; obj.display(); obj.show(); obj.output();", "B obj; obj.show(); obj.output();", "A obj; obj.display(); obj.show(); obj.output();", "C obj; obj.output();"], correctAnswer: 0 },
  { id: 229, week: 3, assignment: 3, question: "Consider the following script:\nclass A {\n  void display() { System.out.println(\"Class A\"); }\n}\nclass B extends A {\n  void show() { System.out.println(\"Class B\"); }\n}\nclass C extends A {\n  void output() { System.out.println(\"Class C\"); }\n}\npublic class Main {\n  public static void main(String[] args) {\n    B objB = new B();\n    objB.display();\n    objB.show();\n    C objC = new C();\n    objC.display();\n    objC.output();\n  }\n}\nWhat is the output of the above program?", options: ["Class A\nClass B\nClass A\nClass C", "Class B\nClass A\nClass C", "Class A\nClass A", "Class B\nClass C"], correctAnswer: 0 },
  { id: 230, week: 3, assignment: 3, question: "Which of the following is true about method overriding in Java?", options: ["The overridden method must have a different return type.", "The overridden method must have the same name and parameters as the base class method.", "The base class method must be private.", "Overriding is not possible in Java."], correctAnswer: 1 },
  { id: 231, week: 3, assignment: 3, question: "Consider the following C++ code:\nclass Base {\npublic:\n  virtual void display() { std::cout << \"Base class\\n\"; }\n};\nclass Derived : public Base {\npublic:\n  void display() override { std::cout << \"Derived class\\n\"; }\n};\nint main() {\n  Base* ptr;\n  Derived obj;\n  ptr = &obj;\n  ptr->display();\n  return 0;\n}\nWhat is the output of the program?", options: ["Base class", "Derived class", "Compilation error", "Undefined behavior"], correctAnswer: 1 },
  { id: 232, week: 3, assignment: 3, question: "Which of the following statements about virtual functions is false?", options: ["Virtual functions allow dynamic (runtime) polymorphism.", "A virtual function must be declared as virtual in the base class.", "A virtual function can have default arguments.", "A virtual function cannot be overridden in a derived class."], correctAnswer: 3 },
  { id: 233, week: 3, assignment: 3, question: "Write a C++ program to demonstrate virtual functions with the following requirements:\n• Base class Shape has a virtual function area().\n• Derived class Rectangle overrides area() to compute the area of a rectangle.\n• Derived class Circle overrides area() to compute the area of a circle.\nWhich of the following correctly uses a base class pointer to call area() for both shapes?", options: ["Shape* ptr; Rectangle rect; ptr = &rect; ptr->area();", "Shape* ptr = new Circle(); ptr->area();", "Both A and B", "None of the above"], correctAnswer: 2 },
  { id: 234, week: 3, assignment: 3, question: "When a class is derived from a base class using protected inheritance, how are the public and protected members of the base class treated in the derived class?", options: ["They both become private members in the derived class.", "They both remain public members in the derived class.", "They both become protected members in the derived class.", "They are inaccessible in the derived class."], correctAnswer: 2 },
  { id: 235, week: 3, assignment: 3, question: "Which of the following is a potential problem associated with multiple inheritance in C++?", options: ["Ambiguity in accessing members when two base classes have members with the same name.", "Lack of runtime polymorphism.", "Inability to overload operators in derived classes.", "Restriction on the number of base classes a derived class can inherit from."], correctAnswer: 0 },
  // OOPs Week 4
  { id: 236, week: 4, assignment: 4, question: "Which of the following best describes polymorphism in object-oriented programming?", options: ["A class having multiple constructors.", "The ability of different objects to respond to the same function call in different ways.", "A function having the same name as its class.", "None of the above."], correctAnswer: 1 },
  { id: 237, week: 4, assignment: 4, question: "Which of the following is an example of static polymorphism?", options: ["Method overloading", "Virtual functions", "Abstract classes", "Method overriding"], correctAnswer: 0 },
  { id: 238, week: 4, assignment: 4, question: "Consider the following code:\nclass Complex {\n  int real, imag;\npublic:\n  Complex (int r, int i) : real(r), imag(i) {}\n  Complex operator+(const Complex& c) {\n    return Complex (real + c.real, imag + c.imag);\n  }\n  void display() {\n    std::cout << real << \"+\" << imag << \"i\" << std::endl;\n  }\n};\nint main() {\n  Complex c1(2,3), c2(4,5);\n  Complex c3=c1+c2;\n  c3.display();\n  return 0;\n}\nWhat is the output of this program?", options: ["6 + 8i", "6 + 15i", "8 + 8i", "Compilation error"], correctAnswer: 0 },
  { id: 239, week: 4, assignment: 4, question: "In a C++ program to overload the * operator for a class Matrix, where:\n• The class stores a 2D matrix as a private member.\n• The * operator multiplies two matrices.\n• The result of multiplication is displayed in the console.\nWhich of the following correctly implements the operator overloading?", options: ["The operator is defined inside the class.", "The operator is defined as a friend function.", "Both A and B are valid.", "Operator overloading is not possible for matrix multiplication."], correctAnswer: 2 },
  { id: 240, week: 4, assignment: 4, question: "Consider the following Java code:\nclass Calculator {\n  int add(int a, int b) { return a+b; }\n  double add(double a, double b) { return a+b; }\n}\npublic class Main {\n  public static void main(String[] args) {\n    Calculator calc = new Calculator();\n    System.out.println(calc.add(2, 3));\n    System.out.println(calc.add(2.5, 3.5));\n  }\n}\nWhat is the output of this program?", options: ["5\n6.0", "5.0\n6.0", "Compilation error", "55"], correctAnswer: 0 },
  { id: 241, week: 4, assignment: 4, question: "Which of the following demonstrates dynamic polymorphism?\nclass Base {\npublic:\n  virtual void display() { std::cout << \"Base class\\n\"; }\n};\nclass Derived : public Base {\npublic:\n  void display() override { std::cout << \"Derived class\\n\"; }\n};\nint main() {\n  Base* ptr;\n  Derived obj;\n  ptr = &obj;\n  ptr->display();\n  return 0;\n}\nWhat is the output of this program?", options: ["Base class", "Derived class", "Compilation error", "Undefined behavior"], correctAnswer: 1 },
  { id: 242, week: 4, assignment: 4, question: "Which of the following is true about virtual functions in C++?", options: ["They allow runtime polymorphism.", "They must be redefined in the derived class.", "They can be called on an object of the base class.", "They cannot be used with pointers."], correctAnswer: 0 },
  { id: 243, week: 4, assignment: 4, question: "Consider the following Java code:\nclass Animal {\n  void sound() { System.out.println(\"Animal makes a sound\"); }\n}\nclass Dog extends Animal {\n  @Override\n  void sound() { System.out.println(\"Dog barks\"); }\n}\npublic class Main {\n  public static void main(String[] args) {\n    Animal animal = new Dog();\n    animal.sound();\n  }\n}\nWhat is the output of this program?", options: ["Animal makes a sound", "Dog barks", "Compilation error", "Undefined behavior"], correctAnswer: 1 },
  { id: 244, week: 4, assignment: 4, question: "Which of the following is a limitation of static polymorphism?", options: ["It requires pointers.", "It is resolved at compile time and cannot adapt to runtime behavior.", "It can only be implemented in C++.", "It cannot be overloaded."], correctAnswer: 1 },
  { id: 245, week: 4, assignment: 4, question: "In a C++ program to demonstrate both static and dynamic polymorphism using the following:\n• Method overloading for static polymorphism.\n• Virtual functions for dynamic polymorphism.\nWhich of the following correctly calls both overloaded and overridden methods?", options: ["Overloaded methods are called directly, and overridden methods are called using a base class pointer.", "Overloaded methods are called using a base class pointer, and overridden methods are called directly.", "Both methods are called directly.", "Both methods require pointers."], correctAnswer: 0 },
  // OOPs Week 5
  { id: 246, week: 5, assignment: 5, question: "Consider the following C++ code:\nclass Example {\nprivate:\n  int secret;\npublic:\n  void setSecret(int value) { secret = value; }\n  int getSecret() { return secret; }\n};\nint main() {\n  Example obj;\n  obj.setSecret(42);\n  std::cout << obj.getSecret();\n  return 0;\n}\nWhat is the output of the program?", options: ["0", "42", "Compilation error", "Undefined behavior"], correctAnswer: 1 },
  { id: 247, week: 5, assignment: 5, question: "Which of the following access specifiers allows a member to be accessible only within the same package in Java?", options: ["private", "protected", "Default (no modifier)", "public"], correctAnswer: 2 },
  { id: 248, week: 5, assignment: 5, question: "Write a C++ program to demonstrate the use of all three access specifiers... Which of the following is true regarding inheritance?", options: ["Private members are accessible in the derived class.", "Protected members are accessible in the derived class.", "Only public members are accessible in the derived class.", "None of the above."], correctAnswer: 1 },
  { id: 249, week: 5, assignment: 5, question: "Consider the following C++ code:\nclass Shape {\npublic:\n  virtual void draw() = 0;\n};\nclass Circle : public Shape {\npublic:\n  void draw() override { std::cout << \"Drawing Circle\" << std::endl; }\n};\nint main() {\n  Circle c;\n  c.draw();\n  return 0;\n}\nWhat is the output of the program?", options: ["Compilation error", "Drawing Circle", "No output", "Undefined behavior"], correctAnswer: 1 },
  { id: 250, week: 5, assignment: 5, question: "Which of the following statements is true about abstract classes and interfaces in Java?", options: ["An abstract class cannot have concrete methods.", "Interfaces can have constructors.", "An interface can extend another interface.", "Abstract classes cannot be inherited."], correctAnswer: 2 },
  { id: 251, week: 5, assignment: 5, question: "Write a Java program that defines an interface Shape with a method area()... What is the correct way to implement the area() method in Circle?", options: ["public double area() { return Math.PI * radius * radius; }", "private double area() { return Math.PI * radius * radius; }", "public void area() { System.out.println(radius * radius); }", "protected double area() { return Math.PI * radius * radius; }"], correctAnswer: 0 },
  { id: 252, week: 5, assignment: 5, question: "Consider the following C++ program:\nclass BankAccount {\nprivate:\n  double balance;\npublic:\n  BankAccount(double initial) : balance(initial) {}\n  void deposit(double amount) { balance += amount; }\n  double getBalance() { return balance; }\n};\nint main() {\n  BankAccount account(100.0);\n  account.deposit(50.0);\n  std::cout << account.getBalance();\n  return 0;\n}\nWhat is the output of this program?", options: ["150.0", "100.0", "Compilation error", "Undefined behavior"], correctAnswer: 0 },
  { id: 253, week: 5, assignment: 5, question: "Which of the following best describes the purpose of data hiding in OOP?", options: ["To optimize memory usage.", "To prevent unauthorized access to class data.", "To allow multiple inheritance.", "To ensure faster compilation."], correctAnswer: 1 },
  { id: 254, week: 5, assignment: 5, question: "What is a key difference between abstract classes and interfaces in Java?", options: ["Abstract classes support multiple inheritance, interfaces do not.", "Abstract classes can have concrete methods, interfaces cannot.", "Interfaces can have static methods, abstract classes cannot.", "An interface can only be implemented, not extended."], correctAnswer: 2 },
  { id: 255, week: 5, assignment: 5, question: "What is required for method overriding in polymorphism?", options: ["The method must have the same name but different parameters.", "The method must have the same name, return type, and parameters in a parent and child class.", "The method must be marked as static.", "The method must be private in the base class."], correctAnswer: 1 },
  // OOPs Week 6
  { id: 256, week: 6, assignment: 6, question: "What is the output of the following C++ code?\ntry { throw 42; } catch (int e) { std::cout << \"Caught exception: \" << e << std::endl; }", options: ["Caught exception: 42", "Compilation error", "Runtime error", "Undefined behavior"], correctAnswer: 0 },
  { id: 257, week: 6, assignment: 6, question: "Which of the following is a checked exception in Java?", options: ["ArithmeticException", "IOException", "NullPointerException", "ArrayIndexOutOfBoundsException"], correctAnswer: 1 },
  { id: 258, week: 6, assignment: 6, question: "Which of the following correctly defines a custom exception in Java and prints \"Custom error\"?", options: ["Custom error", "Compilation error", "No output", "Runtime error"], correctAnswer: 0 },
  { id: 259, week: 6, assignment: 6, question: "Consider the following C++ code:\ntry { throw \"An error occurred\"; }\ncatch (const char* e) { std::cout << \"String exception: \" << e << std::endl; }\ncatch (...) { std::cout << \"Unknown exception caught\" << std::endl; }\nWhat is the output of this program?", options: ["String exception: An error occurred", "Unknown exception caught", "Compilation error", "No output"], correctAnswer: 0 },
  { id: 260, week: 6, assignment: 6, question: "Which of the following is true about unchecked exceptions in Java?", options: ["They must be declared in the method's throws clause.", "They must be handled using a try-catch block.", "They are not checked by the compiler at compile time.", "They do not extend Throwable."], correctAnswer: 2 },
  { id: 261, week: 6, assignment: 6, question: "To write a custom exception class in C++ to handle invalid age inputs, what is the correct signature for the custom exception constructor?", options: ["InvalidAgeException(std::string msg);", "InvalidAgeException(const std::string& msg);", "InvalidAgeException(char* msg);", "All of the above."], correctAnswer: 3 },
  { id: 262, week: 6, assignment: 6, question: "Which of the following statements about the finally block in Java is true?", options: ["It is executed only if no exception is thrown.", "It is executed only if an exception is caught.", "It is executed regardless of whether an exception is thrown or caught.", "It is executed before the catch block."], correctAnswer: 2 },
  { id: 263, week: 6, assignment: 6, question: "To write a Java program that reads an integer input, throws ArithmeticException if negative, IOException if invalid, and catches both. Which implementation is correct?", options: ["Two separate catch blocks for each exception.", "A single catch block with catch (Exception e).", "Nested try-catch blocks.", "Both A and C."], correctAnswer: 3 },
  { id: 264, week: 6, assignment: 6, question: "Select the correct exception type that would be thrown: 'A function is called with an argument that is invalid for its operation.'", options: ["std::invalid_argument", "std::length_error", "std::out_of_range", "std::runtime_error"], correctAnswer: 0 },
  { id: 265, week: 6, assignment: 6, question: "Which of the following statements about the throws keyword in Java is correct?", options: ["The throws keyword must be used for all exceptions.", "The throws keyword is used in the method signature to declare checked exceptions that a method might throw.", "The throws keyword is used to catch and handle exceptions within a method.", "The throws keyword automatically handles the exception without try-catch."], correctAnswer: 1 },
  // OOPs Week 7
  { id: 266, week: 7, assignment: 7, question: "Consider the following C++ code using std::ifstream to read \"example.txt\" line by line and print it. If the file contains \"File Handling in C++\", what is the output?", options: ["File Handling in C++", "Prints nothing.", "Compilation error.", "Undefined behavior."], correctAnswer: 0 },
  { id: 267, week: 7, assignment: 7, question: "To write a C++ program that reads the contents of a file input.txt and copies it to output.txt, which of the following achieves this?", options: ["Using ifstream and ofstream to read and write line by line.", "Using ifstream and ofstream with a buffer.", "Both A and B.", "File copy cannot be achieved in C++."], correctAnswer: 2 },
  { id: 268, week: 7, assignment: 7, question: "To write a Java program to serialize an object of a class Student with attributes name and id, which of the following statements is true?", options: ["The class must implement Serializable.", "Attributes must be declared as private.", "Serialization writes the object to a binary file.", "All of the above."], correctAnswer: 3 },
  { id: 269, week: 7, assignment: 7, question: "What is the correct method to read a serialized object from a file in Java?", options: ["readObject() from the ObjectInputStream.", "deserialize() from the Serializable interface.", "read() from the FileReader.", "deserialize() from the Deserializable interface."], correctAnswer: 0 },
  { id: 270, week: 7, assignment: 7, question: "To write a C++ program to serialize a class Employee... What is the correct method to write and read binary data using file streams?", options: ["ofstream::write() and ifstream::read().", "ofstream::write() and ifstream::getline().", "ofstream::put() and ifstream::get().", "ofstream::getline() and ifstream::getline()."], correctAnswer: 0 },
  { id: 271, week: 7, assignment: 7, question: "To write a Java program to merge the contents of two text files into output.txt, which of the following steps is necessary?", options: ["Open both input files using FileReader.", "Read the contents line by line and write them to the output file using FileWriter.", "Close all the files after the operation is complete.", "All of the above."], correctAnswer: 3 },
  { id: 272, week: 7, assignment: 7, question: "What will be the output of CustomSerializationDemo updating the password field?", options: ["Info: Top Secret Password: 1234567890", "Info: Top Secret Password: 67890", "Info: Top Secret Password: ENC (12345)", "Info: Top Secret Password: ENC (67890)"], correctAnswer: 1 },
  { id: 273, week: 7, assignment: 7, question: "In Java, which of the following statements about the readObject() method when customizing deserialization is correct?", options: ["The readObject() method must call defaultReadObject() to ensure the non-transient fields are correctly deserialized.", "The readObject() method is only used for reading transient fields.", "The readObject() method cannot be overridden in a Serializable class.", "The readObject() method is automatically generated and cannot be customized."], correctAnswer: 0 },
  { id: 274, week: 7, assignment: 7, question: "In C++, when serializing an object by writing its raw memory to a binary file using reinterpret_cast, which is true regarding portability?", options: ["This method ensures platform-independent serialization.", "This method may lead to issues due to differences in endianness, padding, and alignment between systems.", "Guarantees virtual table pointers are correctly serialized.", "C++ provides built-in serialization support handling these issues."], correctAnswer: 1 },
  { id: 275, week: 7, assignment: 7, question: "Considering differences between text mode and binary mode in C++ file I/O, which is accurate?", options: ["In text mode, newline characters are translated to the system's native line-ending, while in binary mode no such translation occurs.", "Binary mode is preferred for text files.", "There is no difference in modern C++.", "Data is automatically compressed in binary mode."], correctAnswer: 0 },
  // OOPs Week 8
  { id: 276, week: 8, assignment: 8, question: "To write a template function in C++ to find the maximum of two values. Which of the following implementations is correct?", options: ["template<typename T> T max(T a, T b) { return (a > b) ? a : b; }", "template<typename T> void max(T a, T b) { return (a > b) ? a : b; }", "template<int T> T max(T a, T b) { return (a > b) ? a : b; }", "template<typename T> T max(int a, int b) { return (a > b) ? a : b; }"], correctAnswer: 0 },
  { id: 277, week: 8, assignment: 8, question: "Which of the following statements is true about template classes in C++?", options: ["Template classes cannot have non-template member functions.", "Template classes can be instantiated for any data type.", "Template classes must inherit from a base class.", "Template classes cannot have constructors."], correctAnswer: 1 },
  { id: 278, week: 8, assignment: 8, question: "To write a C++ program to define a template class Box... Which correctly instantiates the template class?", options: ["Box<int> intBox(42);", "Box<int> intBox;", "Box<int, float> intBox(42);", "Box stringBox(\"Hello\");"], correctAnswer: 0 },
  { id: 279, week: 8, assignment: 8, question: "What is the primary purpose of generics in Java?", options: ["To allow multiple inheritance.", "To perform runtime type checking.", "To enforce compile-time type safety.", "To improve code execution speed."], correctAnswer: 2 },
  { id: 280, week: 8, assignment: 8, question: "To write a generic class in Java called Container... Which of the following correctly defines the class?", options: ["class Container<T> { private T value; }", "class Container { private T value; }", "class Container<T, U> { private T value; }", "class Container (T) { private T value; }"], correctAnswer: 0 },
  { id: 281, week: 8, assignment: 8, question: "To write a Python function get_first_element() using generics that returns the first element. Which is correct?", options: ["def get_first_element(lst): return lst[0]", "from typing import List, TypeVar\nT = TypeVar('T')\ndef get_first_element(lst: List[T]) -> T: return lst[0]", "def get_first_element(lst: List[T]) -> T: return lst[0]", "from typing import TypeVar\nT = TypeVar('T')\ndef get_first_element(lst) -> T: return lst[0]"], correctAnswer: 1 },
  { id: 282, week: 8, assignment: 8, question: "Which of the following is a common use case for templates in C++ and generics in Java?", options: ["Creating reusable and type-safe data structures.", "Enforcing runtime type checking.", "Avoiding the use of constructors.", "Improving execution time by avoiding pointers."], correctAnswer: 0 },
  { id: 283, week: 8, assignment: 8, question: "Which of the following is true about templates in C++ and generics in Java?", options: ["Templates are resolved at runtime, generics at compile time.", "Generics in Java use type erasure, while templates in C++ do not.", "Both support multiple inheritance.", "Templates and generics are identical in their implementation."], correctAnswer: 1 },
  { id: 284, week: 8, assignment: 8, question: "Which of the following is not an advantage of using templates in C++?", options: ["Dynamic Memory Allocation", "Code Reusability", "Performance Efficiency", "Type Safety"], correctAnswer: 0 },
  { id: 285, week: 8, assignment: 8, question: "Consider Java code with List<? super Integer> and adding values. What will happen if we pass List<Double>?", options: ["Compile and print.", "Compile but throw runtime exception.", "Fail to compile because List<Double> is incompatible with List<? super Integer>.", "Fail to compile because it cannot accept Integer values."], correctAnswer: 2 },
  // OOPs Week 9
  { id: 286, week: 9, assignment: 9, question: "Which of the following is an associative container in STL?", options: ["vector", "deque", "set", "list"], correctAnswer: 2 },
  { id: 287, week: 9, assignment: 9, question: "Which of the following containers allows bidirectional iterators in STL?", options: ["vector", "deque", "set", "array"], correctAnswer: 2 },
  { id: 288, week: 9, assignment: 9, question: "In a C++ program with a vector<int> containing 5, 15, 10, 20, 25. Using std::max_element() outputs:", options: ["25", "20", "Compilation error", "Undefined behavior"], correctAnswer: 0 },
  { id: 289, week: 9, assignment: 9, question: "Which of the following is a non-modifying algorithm in STL?", options: ["std::sort()", "std::copy()", "std::find()", "std::remove()"], correctAnswer: 2 },
  { id: 290, week: 9, assignment: 9, question: "Sorting vector<int> 50, 10, 40, 30, 20 in ascending order using std::sort() outputs:", options: ["10 20 30 40 50", "50 40 30 20 10", "Compilation error", "Undefined behavior"], correctAnswer: 0 },
  { id: 291, week: 9, assignment: 9, question: "A map<string, int> with Alice:90, Bob:85, Charlie:95 printed using an iterator outputs:", options: ["Alice: 90, Bob: 85, Charlie: 95", "Bob: 85, Charlie: 95, Alice: 90", "Compilation error", "Undefined behavior"], correctAnswer: 0 },
  { id: 292, week: 9, assignment: 9, question: "A set<int> containing 50, 10, 30, 20, 40 traversed with an iterator and std::find() for 30:", options: ["The output is sorted in ascending order, and 30 is found.", "The output is sorted in descending order, and 30 is not found.", "The elements are printed in the order they were added.", "Compilation error."], correctAnswer: 0 },
  { id: 293, week: 9, assignment: 9, question: "Which of the following operations is not directly supported by the std::list container in C++?", options: ["Insertion of elements at the front", "Insertion of elements at the back", "Direct access to elements by index", "Removal of elements from the front"], correctAnswer: 2 },
  { id: 294, week: 9, assignment: 9, question: "C++ vector {1,2,3,4,5}. advance(it, 2); *it=10; Output?", options: ["1 2 3 4 5", "1 2 10 4 5", "1 2 3 10 5", "1 2 3 4 10"], correctAnswer: 1 },
  { id: 295, week: 9, assignment: 9, question: "C++ deque with operations push_back(10), push_front(20), push_back(30), push_front(40), pop_back(), pop_front(). Output?", options: ["10 30", "20 10", "20 30", "10 20"], correctAnswer: 1 },
  // OOPs Week 10
  { id: 296, week: 10, assignment: 10, question: "Which of the following is the primary purpose of the Singleton pattern?", options: ["To allow multiple instances of a class.", "To restrict a class to a single instance and provide global access to it.", "To create objects based on a condition.", "To improve inheritance in a class hierarchy."], correctAnswer: 1 },
  { id: 297, week: 10, assignment: 10, question: "Analyze the C++ Singleton pattern checking if two getInstance() calls return the same pointer. Output?", options: ["Same instance", "Different instance", "Compilation error", "Undefined behavior"], correctAnswer: 0 },
  { id: 298, week: 10, assignment: 10, question: "To write a Java implementation of the Singleton pattern that ensures thread safety. Which is correct?", options: ["Use synchronized blocks in getInstance().", "Use the volatile keyword with the instance variable.", "Use a static block for initialization.", "All of the above."], correctAnswer: 3 },
  { id: 299, week: 10, assignment: 10, question: "To write a C++ Factory pattern creating Circle and Square inheriting from Shape. Correct createShape() method?", options: ["Shape* createShape(const std::string& type)", "Circle* createShape(const std::string& type)", "Square createShape(const std::string& type)", "Shape createShape(const std::string& type)"], correctAnswer: 0 },
  { id: 300, week: 10, assignment: 10, question: "What is the primary purpose of the Observer pattern?", options: ["To create a single global instance of a class.", "To allow one object to notify multiple objects of a change in its state.", "To encapsulate algorithms in separate classes.", "To improve memory management."], correctAnswer: 1 },
  { id: 301, week: 10, assignment: 10, question: "Which of the following correctly implements the notify() method in the Subject class for an Observer pattern?", options: ["Iterate through the list of observers and call their update() method.", "Use a static method to update all observers.", "Use inheritance to notify all observers.", "Store observer states in a database."], correctAnswer: 0 },
  { id: 302, week: 10, assignment: 10, question: "Which of the following statements is true about Singleton, Factory, and Observer patterns?", options: ["Singleton is for global access, Factory for object creation, and Observer for state management.", "Factory is a creational pattern, while Singleton and Observer are structural patterns.", "Observer pattern is always implemented using threads.", "Singleton pattern ensures that an object is immutable."], correctAnswer: 0 },
  { id: 303, week: 10, assignment: 10, question: "Which of the following use cases combines multiple design patterns?", options: ["A logging system using Singleton for a logger instance and Observer for notifying log subscribers.", "A database system using Factory for creating connections and Observer for managing connection pools.", "Both A and B.", "Design patterns cannot be combined."], correctAnswer: 2 },
  { id: 304, week: 10, assignment: 10, question: "Which of the following statements is true about the adapter pattern in the OldPrinter code?", options: ["The PrinterAdapter class allows OldPrinter to be used directly without any modifications to the OldPrinter class.", "The PrinterAdapter class replaces the OldPrinter class completely.", "The PrinterAdapter class extends PrinterInterface and provides a new method legacyPrint().", "Requires OldPrinter to inherit from PrinterInterface for the code to compile."], correctAnswer: 0 },
  { id: 305, week: 10, assignment: 10, question: "Which of the following is a primary purpose of the Proxy Pattern?", options: ["To allow an object to send notifications to all its observers.", "To provide a surrogate or placeholder for another object to control access and interactions.", "To enable the creation of multiple independent instances of a class.", "To ensure that a class only has one instance."], correctAnswer: 1 },
  // OOPs Week 11
  { id: 306, week: 11, assignment: 11, question: "What is the correct way to join threads after starting them in C++?", options: ["Use thread1.start() and thread1.join().", "Use thread1.join() and thread2.join().", "Use thread1.detach() and thread2.detach().", "Threads cannot be joined in C++."], correctAnswer: 1 },
  { id: 307, week: 11, assignment: 11, question: "Which of the following is true about the Runnable interface in Java?", options: ["It has a method called run() that must be overridden.", "It can only be used with the Thread class.", "It supports multiple inheritance.", "It cannot be implemented in a lambda expression."], correctAnswer: 0 },
  { id: 308, week: 11, assignment: 11, question: "Which of the following correctly starts two threads in Java?", options: ["new Thread(thread1).run(); new Thread(thread2).run();", "thread1.start(); thread2.start();", "new Thread(thread1).start(); new Thread(thread2).start();", "thread1.run(); thread2.run();"], correctAnswer: 2 },
  { id: 309, week: 11, assignment: 11, question: "Which of the following is the correct method to bind a Python TCP server to a port?", options: ["server.bind(('localhost', 8080))", "server.listen(8080)", "server.start(('localhost', 8080))", "server.connect(('localhost', 8080))"], correctAnswer: 0 },
  { id: 310, week: 11, assignment: 11, question: "Which of the following methods is used to add an event listener to a button in Java Swing?", options: ["button.addActionListener()", "button.addListener()", "button.onClick()", "button.setActionListener()"], correctAnswer: 0 },
  { id: 311, week: 11, assignment: 11, question: "Which of the following is essential for a multithreaded TCP server to handle multiple clients?", options: ["Use thread.join() for each client connection.", "Use a separate thread for each client connection.", "Use a single thread for all client connections.", "Use the poll() function to manage threads."], correctAnswer: 1 },
  { id: 312, week: 11, assignment: 11, question: "In the C++ EarthquakeMonitor Observer pattern, only magnitudes > 5.0 trigger alerts. What is the output for 4.2 and 5.8?", options: ["Alerts for both 4.2 and 5.8", "Alert: Significant earthquake of magnitude 5.8 detected!", "No output", "Runtime error"], correctAnswer: 1 },
  { id: 313, week: 11, assignment: 11, question: "In Java, using the 'synchronized' keyword on a method called by two threads ensures:", options: ["Both threads interleave their output.", "Only Thread-1 completes its task.", "Both execute concurrently without synchronization.", "Thread-1 completes fully before Thread-2 starts."], correctAnswer: 3 },
  { id: 314, week: 11, assignment: 11, question: "Which scenario causes a thread to transition directly from 'Running' to 'Terminated' state in Java?", options: ["The join() method is invoked.", "The thread completes its execution of the run() method.", "The sleep() method is called.", "The thread encounters contention for a lock."], correctAnswer: 1 },
  { id: 315, week: 11, assignment: 11, question: "What does std::async(std::launch::async, computeValue) demonstrate in C++?", options: ["Parallel computation using a new thread for computeValue().", "Deferred execution until get() is called.", "Immediate execution in the main thread.", "Compilation error."], correctAnswer: 0 },
  // OOPs Week 12
